...
from buildbot.changes  import bzr_buildbot
...
class ChangePerspective(NewCredPerspective):
    ...
    def perspective_addChange(self, changedict):
        ...
        pathnames = []
	print "changes files ", changedict['files']
        prefixpaths = None
...
class PBChangeSource(base.ChangeSource):
	...
	print "start called-------"
	#bzrpoller = bzr_buildbot.BzrPoller(location="bzr+ssh://bazaar.launchpad.net/%7Eopenerp-commiter/openobject-server/pa        p-etree-trunk",pollinterval=10*60)
	bzrpoller = bzr_buildbot.BzrPoller(location="https://code.launchpad.net/openobject-server/pap-etree-trunk")
	print "start service in pb called-------",bzrpoller
